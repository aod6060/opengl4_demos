...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect_normal_map/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect_normal_map/shader.frag");
		...
		// Handle Skybox
		// Create Shader
		skyboxVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect_normal_map/skybox.vert");
		skyboxFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect_normal_map/skybox.frag");
		...
		envmapVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect_normal_map/envmap.vert");
		envmapFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect_normal_map/envmap.frag");
	...
	virtual void render() {
		...
		glm::mat4 model = glm::translate(glm::vec3(0.0f, 2.0f, -10.0f)) * glm::rotate(yrot, glm::vec3(0.0f, 1.0f, 0.0f));
