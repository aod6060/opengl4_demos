obj_to_smf ./data/meshes/barrel.obj ./data/meshes/barrel.smf
obj_to_smf ./data/meshes/cube.obj ./data/meshes/cube.smf
obj_to_smf ./data/meshes/death_donut.obj ./data/meshes/death_donut.smf
