...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect/shader.frag");
		...
		// Handle Skybox
		// Create Shader
		skyboxVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect/skybox.vert");
		skyboxFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect/skybox.frag");
		...
		envmapVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_reflect/envmap.vert");
		envmapFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_reflect/envmap.frag");
