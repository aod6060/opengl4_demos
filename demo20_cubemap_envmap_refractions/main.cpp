...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_refract/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_refract/shader.frag");
		...
		// Handle Skybox
		// Create Shader
		skyboxVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_refract/skybox.vert");
		skyboxFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_refract/skybox.frag");
		...
		envmapVertexShader.init(GL_VERTEX_SHADER, "data/shaders/envmap_refract/envmap.vert");
		envmapFragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/envmap_refract/envmap.frag");
...
int main(int argc, char** argv) {
	MaterialApp app;
	app_init("Cubemap: Enviormental Mappinging, Refraction", 1366, 768, &app);
	app_update();
	app_release();
	return 0;
}