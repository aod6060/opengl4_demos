...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/material/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/material/shader.frag");
...
int main(int argc, char** argv) {
	MaterialApp app;
	app_init("Lighting Materials", 1366, 768, &app);
	app_update();
	app_release();
	return 0;
}