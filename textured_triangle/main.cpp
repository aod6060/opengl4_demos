...
class TexturedTriangleApp : public IApp {
public:
	...
	virtual void init() {
		...
		std::string vsrc = util_loadTextFile("data/shaders/textured_tris/shader.vert");
		std::string fsrc = util_loadTextFile("data/shaders/textured_tris/shader.frag");
...
int main(int argc, char** argv) {
	...
	TexturedTriangleApp app;

	app_init("Textured Triangle Application", 800, 600, &app);
