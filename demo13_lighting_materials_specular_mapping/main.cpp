...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/material_specular_mapping/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/material_specular_mapping/shader.frag");
...
int main(int argc, char** argv) {
	MaterialApp app;
	app_init("Lighting Materials Specular Material", 1366, 768, &app);
	app_update();
	app_release();
	return 0;
}