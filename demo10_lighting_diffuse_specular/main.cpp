...
public:
	...
	virtual void init() {
		...
		// Shader
		vertexShader.init(GL_VERTEX_SHADER, "data/shaders/lighting_diffuse_specular/shader.vert");
		fragmentShader.init(GL_FRAGMENT_SHADER, "data/shaders/lighting_diffuse_specular/shader.frag");
...
int main(int argc, char** argv) {
	...
	app_init("Lighting Diffuse Specular App", 1366, 768, &app);
	app_update();
	app_release();
	return 0;
}